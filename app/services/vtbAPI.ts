export namespace Schemas {
  ...
  export type Health = {
    ...
    rag_system_initialized: boolean;
    database_connected: number;
    timestamp: string;
  };
...
export namespace Endpoints {
  ...
  export type get_Health_check_health__get = {
    method: "GET";
    path: "/health/";
    requestFormat: "json";
    parameters: never;
    responses: { 200: Schemas.Health };
  };
  export type get_Get_system_stats_health_stats_get = {
    method: "GET";
    path: "/health/stats";
    requestFormat: "json";
    parameters: never;
  ...
  export type get_Get_patients_list_patients__get = {
    method: "GET";
    path: "/patients/";
    requestFormat: "json";
    parameters: never;
  ...
  export type get_Get_patient_by_id_patients__patient_id__get = {
    method: "GET";
  ...
  export type get_Get_patient_clinical_patients__patient_id__clinical_get = {
    method: "GET";
    path: "/patients/{patient_id}/clinical";
    requestFormat: "json";
    parameters: {
      path: { patient_id: string };
    };
  ...
  export type get_Get_patient_mutations_patients__patient_id__mutations_get = {
    method: "GET";
    path: "/patients/{patient_id}/mutations";
    requestFormat: "json";
    parameters: {
      path: { patient_id: string };
    };
  ...
  export type get_Get_patient_dcna_patients__patient_id__dcna_get = {
    method: "GET";
    path: "/patients/{patient_id}/dcna";
    requestFormat: "json";
    parameters: {
      path: { patient_id: string };
    };
  ...
  export type get_Get_patient_summary_patients__patient_id__summary_get = {
    method: "GET";
    path: "/patients/{patient_id}/summary";
    requestFormat: "json";
    parameters: {
      path: { patient_id: string };
    };
...
export type EndpointByMethod = {
  get: {
    "/health/": Endpoints.get_Health_check_health__get;
    "/health/stats": Endpoints.get_Get_system_stats_health_stats_get;
    "/patients/": Endpoints.get_Get_patients_list_patients__get;
    "/patients/{patient_id}": Endpoints.get_Get_patient_by_id_patients__patient_id__get;
    "/patients/{patient_id}/clinical": Endpoints.get_Get_patient_clinical_patients__patient_id__clinical_get;
    "/patients/{patient_id}/mutations": Endpoints.get_Get_patient_mutations_patients__patient_id__mutations_get;
    "/patients/{patient_id}/dcna": Endpoints.get_Get_patient_dcna_patients__patient_id__dcna_get;
    "/patients/{patient_id}/summary": Endpoints.get_Get_patient_summary_patients__patient_id__summary_get;
    "/": Endpoints.get_Root__get;
  };
};
